...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FirebaseAppCheckInterop-iOS/FirebaseAppCheckInterop.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FirebaseFirestoreInternal-iOS/FirebaseFirestoreInternal.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FirebaseInstallations/FirebaseInstallations.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FirebaseSharedSwift-iOS/FirebaseSharedSwift.framework"
